from .views import ProductListView ,ProductDetailView,deleteProduct,UpdateProductView,add_product, myProductsListView 
...
urlpatterns=[
    ...
    path(r'delete/?P<slug>/',deleteProduct,name="product_delete"),
